...
<link href="css/updatePasswordLayout.css" rel="stylesheet" type="text/css">
  ...
  <div id="login_box">
    <form METHOD="POST" id="login">
        <p><span id="sprytextfield1">
          <label for "email">Your Email</label> <input name="email" type="text" id="email" placeholder="Email"><br><br>
          <label for "newPass">New Password</label> <input name="email" type="text" id="email" placeholder="Email"><br><br>
          <label for "conPass">Confirm Password</label> <input name="email" type="text" id="email" placeholder="Email"><br><br>
...
$totalRows_emailAuth = mysql_num_rows($emailAuth);
 ...
 if($totalRows_emailAuth){
	...
	mail($to,$email_subject,$email_body,$headers);
	 ...
	 //display message
	 echo "<div id='correctEmail'>Password reset link has been sent to your Email </div>";
